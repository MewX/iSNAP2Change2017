            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        School Information Table <span class="glyphicon glyphicon-plus pull-right" data-toggle="modal"
                    ...
                    <div class="panel-body">
                                    ...
                                    <tr class="<?php if ($i % 2 == 0) {
                                        ...
                                        <td><?php $count = 0;
                                            for ($j = 0; $j < count($classNumResult); $j++) {
                                                if ($classNumResult[$j]->SchoolID == $schoolResult[$i]->SchoolID) $count = $classNumResult[$j]->Count;
                                            }
                                            echo $count; ?><span class="glyphicon glyphicon-remove pull-right"
                                                                 aria-hidden="true"></span><span class="pull-right"
                        ...
                        <div class="well row">
                            ...
                            <div class="alert alert-danger">
                                <p><strong>Reminder</strong> : If you remove one school. All the student data in this
                                    school will also get deleted (not recoverable).</p> It includes <strong>student
                                    information, their submissions of every task and your grading/feedback</strong>, not
                                only the school itself.
                            </div>
                        </div>
                    </div>
                    <!-- /.panel-body -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="submission" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <br>
                    <div class="alert alert-danger">
                        <p><strong>Reminder</strong> : School Name should be unique and no duplicate names are allowed.
                        </p>
                    </div>
                </form>
            </div>
